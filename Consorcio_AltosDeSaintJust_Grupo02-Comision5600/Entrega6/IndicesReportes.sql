...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_pago_fecha_detalle_R1' AND object_id = OBJECT_ID('pago'))
CREATE NONCLUSTERED INDEX IX_pago_fecha_detalle_R1 
ON pago (fecha, id_detalleDeCuenta)
INCLUDE (importe)
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_ecp_detalle_valores_R1' AND object_id = OBJECT_ID('estadoCuentaProrrateo'))
CREATE NONCLUSTERED INDEX IX_ecp_detalle_valores_R1 
ON estadoCuentaProrrateo (id_detalleDeCuenta)
INCLUDE (id_expensa, total_pagar, expensas_ordinarias, expensas_extraordinarias)
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_expensa_consorcio_R1' AND object_id = OBJECT_ID('expensa'))
CREATE NONCLUSTERED INDEX IX_expensa_consorcio_R1 
ON expensa (id_consorcio)
INCLUDE (id_expensa)
GO
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_pago_fecha_detalle' AND object_id = OBJECT_ID('pago'))
CREATE NONCLUSTERED INDEX IX_pago_fecha_detalle 
ON pago (fecha, id_detalleDeCuenta)
INCLUDE (importe)
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_ecp_detalleDeCuenta_uf' AND object_id = OBJECT_ID('estadoCuentaProrrateo'))
CREATE NONCLUSTERED INDEX IX_ecp_detalleDeCuenta_uf 
ON estadoCuentaProrrateo (id_detalleDeCuenta)
INCLUDE (id_uf)
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_uf_consorcio_piso_depto' AND object_id = OBJECT_ID('unidadFuncional'))
CREATE NONCLUSTERED INDEX IX_uf_consorcio_piso_depto 
ON unidadFuncional (id_consorcio, piso)
INCLUDE (id_uf, depto)
GO
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_expensa_consorcio_periodo' AND object_id = OBJECT_ID('expensa'))
CREATE NONCLUSTERED INDEX IX_expensa_consorcio_periodo 
ON expensa (id_consorcio, periodo)
INCLUDE (id_expensa)
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_ecp_id_expensa_conceptos' AND object_id = OBJECT_ID('estadoCuentaProrrateo'))
CREATE NONCLUSTERED INDEX IX_ecp_id_expensa_conceptos 
ON estadoCuentaProrrateo (id_expensa)
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_puf_propietario_dni_uf' AND object_id = OBJECT_ID('personaUf'))
CREATE NONCLUSTERED INDEX IX_puf_propietario_dni_uf 
ON personaUf (tipo_responsable) 
INCLUDE (dni_persona, id_uf)
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_ecp_id_uf_deuda' AND object_id = OBJECT_ID('estadoCuentaProrrateo'))
CREATE NONCLUSTERED INDEX IX_ecp_id_uf_deuda 
ON estadoCuentaProrrateo (id_uf)
INCLUDE (deuda) 
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_uf_id_consorcio' AND object_id = OBJECT_ID('unidadFuncional'))
CREATE NONCLUSTERED INDEX IX_uf_id_consorcio
ON unidadFuncional (id_consorcio)
INCLUDE (id_uf)
GO
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_pago_fecha_detalle_R6' AND object_id = OBJECT_ID('pago'))
CREATE NONCLUSTERED INDEX IX_pago_fecha_detalle_R6 
ON pago (fecha)
INCLUDE (id_detalleDeCuenta)
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_ecp_detalle_ordinarias_uf_R6' AND object_id = OBJECT_ID('estadoCuentaProrrateo'))
CREATE NONCLUSTERED INDEX IX_ecp_detalle_ordinarias_uf_R6 
ON estadoCuentaProrrateo (id_detalleDeCuenta)
INCLUDE (id_uf, expensas_ordinarias)
GO

IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_uf_consorcio_id_R6' AND object_id = OBJECT_ID('unidadFuncional'))
