...
Enunciado:        "Ejecucion de Reportes"
*/
...
EXEC rep.SP_Reporte_3_RecaudacionTipoPeriodo 
    @idConsorcio = @ConsorcioID, 
...
EXEC rep.SP_Reporte_5_Top3Morosos @idConsorcio = @ConsorcioID;
GO
...
EXEC rep.SP_Reporte_6_PeriodicidadPagosUF 
    @idConsorcio = @ConsorcioID, 
